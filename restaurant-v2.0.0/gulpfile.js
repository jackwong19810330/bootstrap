...
const PATHS = {
  ...
  JS: {
    ...
    PLUGINS: ['js/plugins/imagesloaded.pkgd.js', 'js/plugins/TweenMax.js', 'js/plugins/ScrollToPlugin.js', 'js/plugins/CustomEase.js', 'js/plugins/all.min.js'],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
  ...
  DEPENDENCIES: {
    ...
    'flexslider': {
      FROM: ['node_modules/flexslider/jquery.flexslider-min.js', 'node_modules/flexslider/flexslider.css'],
      TO: lib,
    },
    'jquery.mb.ytplayer': {
      FROM: ['node_modules/jquery.mb.ytplayer/dist/css/jquery.mb.YTPlayer.min.css', 'node_modules/jquery.mb.ytplayer/dist/jquery.mb.YTPlayer.min.js'],
